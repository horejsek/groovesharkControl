...
goog.string.compareVersions=function(a,b){for(var c=0,d=goog.string.trim(""+a).split("."),e=goog.string.trim(""+b).split("."),f=Math.max(d.length,e.length),g=0;0==c&&g<f;g++){var h=d[g]||"",k=e[g]||"",l=RegExp("(\\d*)(\\D*)","g"),p=RegExp("(\\d*)(\\D*)","g");do{var m=l.exec(h)||["","",""],n=p.exec(k)||["","",""];if(0==m[0].length&&0==n[0].length)break;var c=0==m[1].length?0:parseInt(m[1],10),q=0==n[1].length?0:parseInt(n[1],10),c=goog.string.compareElements_(c,q)||goog.string.compareElements_(0==
...
goog.dom.DomHelper.prototype.getAncestorByClass=goog.dom.getAncestorByClass;goog.dom.DomHelper.prototype.getAncestor=goog.dom.getAncestor;(function(){var a,b,c,d,e,f,g,h,k,l,p,m,n,q,s,t,u,v,w,r,x,y,z,A,B,C,D,E,F,G,H,I,i,o,j;r=function(){var a;a={type:"update",player:h(),playback:g(),currentSong:f(),queue:k(),autoplay:e()};return chrome.extension.sendRequest(a,x)};x=function(a){if("undefined"===typeof a)return console.log("clear interval & remove listener"),clearInterval(c),chrome.extension.onRequest.removeListener(l)};h=function(){var a,b,c;b=j("#repeat","one")?"one":j("#repeat","active")?"all":"none";c=(a=j("#volume","mute"))?0:parseInt(document.querySelector("#volume-slider .ui-slider-range").style.height);
return{loop:b,shuffle:j("#shuffle","active"),crossfade:j("#crossfade","active"),volume:c,isMute:a}};g=function(){return j("#play-pause","disabled")?{status:"UNAVAILABLE",percentage:null,position:null,duration:null}:{status:j("#play-pause","playing")?"PLAYING":"STOPPED",percentage:parseFloat(document.querySelector("#progress-bar #elapsed").style.width),position:document.querySelector("#time-elapsed").textContent,duration:document.querySelector("#time-total").textContent}};f=function(){var a,b;if(!j("#play-pause",
"disabled"))return(a=o("#now-playing-image","src"))?(b=a.replace("40_","70_"),a=a.replace("40_","90_")):b=a=void 0,{songId:o("#now-playing-metadata .song","data-song-id"),songName:o("#now-playing-metadata .song","title"),artistId:void 0,artistName:o("#now-playing-metadata .artist","title"),albumId:void 0,albumName:"",albumImage70:b,albumImage90:a,fromLibrary:j("#now-playing #np-add","active"),isFavorite:j("#now-playing #np-fav","active"),isSmile:j("#queue-list .queue-item-active .smile","active"),
isFrown:j("#queue-list .queue-item-active .frown","active"),token:void 0}};k=function(){var a,b,c,d,e,f,g,h;e=document.querySelectorAll(".queue-item");f=[];c=0;a=b=void 0;for(g=0,h=e.length;g<h;g++)d=e[g],"none"!==d.style.display&&(f.push({songId:o(".queue-song-name","data-song-id",d),songName:o(".queue-song-name","title",d),artistId:void 0,artistName:o(".queue-song-artist","title",d),albumId:void 0,albumName:void 0,queueSongId:c+1}),goog.dom.classes.has(d,"queue-item-active")&&(b=c,a=c+1),c++);return{songs:f,
activeSongIndex:b,activeSongId:a}};e=function(){return{enabled:j(".queue-radio-options","active",document.querySelector(".queue-item"))}};j=function(a,b,c){a=(c||document).querySelector(a);return goog.dom.classes.has(a,b)};o=function(a,b,c){return(c||document).querySelector(a).getAttribute(b)};d=function(c,d){switch(c){case "playSong":return q();case "pauseSong":return m();case "playPause":return n();case "previousSong":return t();case "nextSong":return p();case "setSuffle":return setSuffle(d.shuffle);
case "toggleShuffle":return H();case "setCrossfade":return setCrossfade(d.crossfade);case "toggleCrossfade":return B();case "setLoop":return setLoop(d.loop);case "toggleLoop":return F();case "toggleMute":return G();case "setVolume":return y(d.volume);case "addToLibrary":return b(d.songId);case "removeFromLibrary":return v(d.songId);case "toggleLibrary":return E();case "addToFavorites":return a(d.songId);case "removeFromFavorites":return u(d.songId);case "toggleFavorite":return C();case "toggleSmile":return I();
case "toggleFrown":return D();case "seekTo":return w(d.seekTo);case "playSongInQueue":return s(d.queueSongId);case "toggleAutoplay":return A();case "shareCurrentSong":return z()}};q=function(){return i("#play-pause")};m=function(){return i("#play-pause")};n=function(){return i("#play-pause")};t=function(){return i("#play-prev")};p=function(){return i("#play-next")};H=function(){return i("#shuffle")};B=function(){return i("#crossfade")};F=function(){return i("#repeat")};G=function(){return i("#volume")};
y=function(){};b=function(){};v=function(){};E=function(){return i("#np-add")};a=function(){};u=function(){};C=function(){return i("#np-fav")};I=function(){return i("#queue-list .queue-item-active .smile")};D=function(){return i("#queue-list .queue-item-active .frown")};w=function(a){return getGrooveshark().seekToPosition(getGrooveshark().getCurrentSongStatus().song.calculatedDuration/100*a)};s=function(a){return document.querySelectorAll(".queue-song .play")[a-1].click()};A=function(){};z=function(){return i("#np-share")};
i=function(a,b){return(b||document).querySelector(a).click()};c=setInterval(function(){return r()},1E3);l=function(a){if("undefined"!==typeof a.command)return d(a.command,a.args),r()};return chrome.extension.onRequest.addListener(l)})();
