...
isFrown:k("#queue-list .queue-item-active .frown","active"),token:void 0}};j=function(){var a,b,c,d,e,f,g,h;e=document.querySelectorAll(".queue-item");f=[];c=0;a=b=void 0;for(g=0,h=e.length;g<h;g++)d=e[g],"none"!==d.style.display&&(f.push({songId:o(".queue-song-name","data-song-id",d),songName:o(".queue-song-name","title",d),artistId:void 0,artistName:o(".queue-song-artist","title",d),albumId:void 0,albumName:void 0,queueSongId:c+1}),goog.dom.classes.has(d,"queue-item-active")&&(b=c,a=c+1),c++);return{songs:f,
activeSongIndex:b,activeSongId:a}};e=function(){return{enabled:void 0}};k=function(a,b,c){a=(c||document).querySelector(a);return goog.dom.classes.has(a,b)};o=function(a,b,c){return(c||document).querySelector(a).getAttribute(b)};d=function(c,d){switch(c){case "playSong":return q();case "pauseSong":return m();case "playPause":return n();case "previousSong":return t();case "nextSong":return p();case "setSuffle":return setSuffle(d.shuffle);case "toggleShuffle":return H();case "setCrossfade":return setCrossfade(d.crossfade);
